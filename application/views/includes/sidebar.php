    ...
    <aside
      class="fixed top-0 left-0 z-40 w-64 h-screen pb-28 pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
      aria-label="Sidenav"
        ...
        <ul class="space-y-2">
          ...
          <li>
            ...
            >
              ...
              <span
                class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-sky-800 bg-sky-100 dark:bg-sky-200 dark:text-sky-800"
              >
                4
              </span>
            </a> -->
