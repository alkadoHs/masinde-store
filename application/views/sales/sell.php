                                    ...
                                    <input type="hidden" name="cartId" value="<?= $cartId ?>">
                                        ...
                                        <div>
                                            <label for="default" class="block mb-2 text-sm font-medium text-gray-900">Cash/Credit</label>
                                                <select id="default" name="paymentMethod" class="bg-gray-50 border border-gray-300 text-gray-900 mb-6 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
