  ...
  <main class="py-4 px-2 lg:px-4 md:ml-64 h-auto pt-20 ">
    <?php if($this->session->flashdata('sales_confirmed')): ?>
              <div id="toast-success" class="flex items-center w-full p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                ...
                <div class="ml-3 text-sm font-normal"><?= $this->session->flashdata('sales_confirmed') ?></div>
        ...
        <?php endif ?>
            ...
            <div class="max-w-screen-xl mx-auto lg:px-12 w-full">
                ...
                <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                    <?php echo form_open('vendorProduct/add_transfer', array('class'=> 'flex flex-col gap-4 w-full p-4')); ?>
                    <div class="w-full grid grid-cols-1 md:grid-cols-2 items-center gap-4 shrink">
                        <div class="relative w-full">
                            <label for="select2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Products</label>
                            <select name="product[]" class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" style="width: 100%" id="select2" multiple="true">
                        ...
                        <div>
                            <label for="toUserId" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Vendor</label>
                            <select id="toUserId" name="toUserId" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" required>
                            ...
                            <table id="productTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        ...
                                        <th style="font-weight: 400; font-size: small">
                                            CONFIRM
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $orderitem->name ?></th>
                                        <td class="px-4 py-3">
