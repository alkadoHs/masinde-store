    ...
    <?php elseif($this->session->flashdata('complete_purchaseorder_success')): ?>
        ...
        <?php endif ?>
            ...
            <div class="max-w-screen-xl mx-auto lg:px-12 w-full">
                 <h2 class="text-white text-lg font-bold p-3 bg-emerald-900 rounded">Confirm Transfers</h2>
                            ...
                            <table id="productTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $orderitem->from ?></th>
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $orderitem->name ?></th>
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $orderitem->brand ?></th>
                                        <td class="px-4 py-3">
                                            <input type="hidden" name="id[]" value="<?= $orderitem->id ?>">
                                            <input type="number" readonly name="quantity[]" value="<?= $orderitem->quantity ?>" id="quantity2" class="bg-gray-50 border max-w-[100px] min-w-[80px] border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
