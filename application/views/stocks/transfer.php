        ...
        <div class="max-w-screen-xl mx-auto lg:px-12 w-full">
            ...
            <?php if (count($orderitems) == 0): ?>
                <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                    <?php echo form_open('stock/add_transfer', array('class' => 'flex flex-col gap-4 w-full p-4')); ?>
                    <div class="w-full grid grid-cols-1 md:grid-cols-2 items-center gap-4 shrink">
                        <div class="relative w-full">
                            ...
                            <select name="product[]"
                                ...
                                style="width: 100%" id="select2" multiple="true">
                        ...
                        <div>
                            <label for="toBranchId"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Transfer To</label>
            ...
            <section class="bg-gray-50 dark:bg-gray-900 py-3">
                <div class="mx-auto max-w-screen-xl lg:px-4">
                    ...
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        ...
                        <div class="overflow-x-auto whitespace-nowrap">
                            <table id="productTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        <th scope="col" class="px-4 py-3">TO BRANCH</th>
                                        <th scope="col" class="px-4 py-3">PRODUCT NAME</th>
                                        <th scope="col" class="px-4 py-3">A.STOCK</th>
                                    ...
                                    <?php foreach ($orderitems as $orderitem): ?>
                                        <tr class="border-b dark:border-gray-700">
                                            ...
                                            <td class="px-4 py-3 flex items-center justify-end">
                                                <a href="<?= site_url('stock/cancel_transfer/' . $orderitem->id) ?>"
                                                    type="button"
                        ...
                        <div class="overflow-x-auto whitespace-nowrap">
                            <h3 class="text-zinc-800 font-semibold text-2xl my-3">Recently transfered products</h3>
                            <table id="productTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                ...
                                <tbody>
                                    <?php $totalPrice = 0; ?>
                                    <?php $orderId = null; ?>
                                    <?php foreach ($transfered_products as $orderitem): ?>
                                        <tr class="border-b dark:border-gray-700">
                                            <td class="px-4 py-3">
                                                <?= $orderitem->branch ?>
                                            </td>
