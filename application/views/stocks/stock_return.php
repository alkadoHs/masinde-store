        ...
        <div class="max-w-screen-xl mx-auto lg:px-12 w-full">
            ...
            <?php if (count($orderitems) == 0): ?>
                <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                    <?php echo form_open('vendorProduct/return_product', ['class' => 'flex flex-col gap-4 w-full p-4']); ?>
                    <div class="w-full grid grid-cols-1 md:grid-cols-2 items-center gap-4 shrink">
                        <div class="relative w-full">
                            <label for="select2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select
                                Products</label>
                            <select name="product[]"
                                class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500"
                                style="width: 100%" id="select2" multiple="true" required>
                        ...
                        <div>
                            <label for="toBranchId"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Return To</label>
                    ...
                    <button type="submit"
                        class="flex items-center inset-0 m-auto w-fit h-fit justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:ring-sky-300 dark:bg-sky-600 dark:hover:bg-sky-700 focus:outline-none dark:focus:ring-sky-800">
            ...
            <section class="bg-gray-50 dark:bg-gray-900 py-3">
                <div class="mx-auto max-w-screen-xl lg:px-4">
                    ...
                    <?php if ($this->session->flashdata('purchaseorderitem_canceled')): ?>
                        <div id="toast-success"
                            ...
                            <div class="ml-3 text-sm font-normal">
                                <?= $this->session->flashdata('purchaseorderitem_canceled') ?>
                            </div>
                            <button type="button"
                    ...
                    <?php elseif ($this->session->flashdata('return_added')): ?>
                        <div id="toast-success"
                            class="flex items-center w-full p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
                            role="alert">
                            <div
                            ...
                            <div class="ml-3 text-sm font-normal">
                                <?= $this->session->flashdata('return_added') ?>
                            </div>
                            <button type="button"
                                class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
                                data-dismiss-target="#toast-success" aria-label="Close">
                    ...
                    <?php elseif ($this->session->flashdata('product_returned')): ?>
                        <div id="toast-success"
                            class="flex items-center w-full p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
                            role="alert">
                            <div
                            ...
                            <div class="ml-3 text-sm font-normal">
                                <?= $this->session->flashdata('product_returned') ?>
                            </div>
                            <button type="button"
                                class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
                                data-dismiss-target="#toast-success" aria-label="Close">
                    ...
                    <?php elseif ($this->session->flashdata('stock_return_deleted')): ?>
                        <div id="toast-success"
                            class="flex items-center w-full p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
                            role="alert">
                            <div
                            ...
                            <div class="ml-3 text-sm font-normal">
                                <?= $this->session->flashdata('stock_return_deleted') ?>
                            </div>
                            <button type="button"
                                class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
                                data-dismiss-target="#toast-success" aria-label="Close">
                                    ...
                                    <?php foreach ($orderitems as $orderitem): ?>
                                        <tr class="border-b dark:border-gray-700">
                                            <th scope="row"
                                                ...
                                                <?= $orderitem->name . " . " . "<span style='color: green'>$orderitem->inventory</span>" ?>
                                            </th>
                                            <td class="px-4 py-3">
                                                <?= $orderitem->branch ?>
                                            </td>
                                            <td class="px-4 py-3">
                                                ...
                                                <input type="number" name="quantity[]" value="<?= $orderitem->quantity ?>"
                                                    id="quantity"
                                                    class="bg-gray-50 border max-w-[100px] min-w-[80px] border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                    required="">
                                            </td>
                                            <td class="px-4 py-3 flex items-center justify-end">
                                                <a href="<?= site_url('stock/cancel_stock_return/' . $orderitem->id) ?>"
                                                    type="button"
...
<script>
    $(document).ready(function () {
        $('#updateButton').on('click', function () {
            ...
            $.ajax({
                url: "<?= site_url('vendorProduct/return_to_branch') ?>",
                type: 'POST',
                data: formData,
