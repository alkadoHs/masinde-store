  ...
  <main class="p-4  md:ml-64 h-auto pt-20 ">
    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <h2 class="text-xl  text-slate-700 my-3">-Products Sold By <b class="text-sky-700"><?= $user->username ?></b> </h2>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= format_price($expense['amount']) ?></td>
                        </tr>
                        <?php endforeach ?>
                    </tbody>
                    <tfoot class="text-green-600">
                        <th>#</th>
                        <th>TOTAL</th>
                        <th><?= format_price($total_amount) ?></th>
                    </tfoot>
                </table>
            </div>
